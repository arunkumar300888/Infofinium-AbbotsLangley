function searchBtnLinksClicked() {
	...
	if (documentName == "" && owner == "" && ebNo == "" && keywords == ""
		...
		$.ajax({
			type : "POST",
			url : "searchLinks?adminMeta"+adminMeta,
			cache : false,
...
function mailUserDetailsClicked(userId) {
	//alert("inside mail sender");
	loadProgress();
	$("#userId").val(userId);
	$("#frmUserEmail").attr("action", "user/emailUserDetails");
	$("#frmUserEmail").submit();
}
...
function downloadReferenceLinks(path, name, url) {
	//alert("path:" +path + "Url:" +url+"name:" +name);
	$('#path').val(path);
	$('#name').val(name);
...
function attributeUpdate() {
	...
	if(attr==""){
		...
		dialogTemplateLinks("Attributes", "Field is mandatory");
		return false;
	}
	$.ajax({
		type : "POST",
...
function showFormsForSecGrp() {
	$.ajax({
		type : "GET",
		url : "forms/goShowFormTypes",
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
...
function showFormsForCompanyGrp() {
	$.ajax({
		type : "GET",
		url : "company/goShowFormTypes",
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
			$('#formCompLists').dataTable({
				"bJQueryUI" : true,
				"sPaginationType" : "full_numbers",
				"iDisplayLength" : 25,
				"sScrollY" : "390px",
...
function showAllWipDocs(){
	loadProgress();
	$.ajax({
		type : "GET",
		url : "adminTemplate/showWipDocs",
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
...
function modelAssignementCreation() {
	...
	if (project == "-1" || category == "-1" || discipline == "-1" || company == "-1" 
...
function showCompany() {
	...
	$.ajax({
		type : "GET",
		url : "company/goShowCompanyMaster",
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
...
function showCreateCompany() {
	...
	$.ajax({
		type : "GET",
		url : "company/goShowCreateCompany",
		cache : false,
		success : function(data) {
			$("#dynamicContent").html(data);
		}
...
function createCompany() {
	...
	var abbreviation = $('#bbreviation').val();
	

	if (companyName == "" || abbreviation == "") {
		dialogTemplateLinks("Company Creation", "All fields are mandatory");
		return false;
	}
	...
	$.ajax({
		...
		cache : false,
		data : $('#createCompanyFrm').serialize(),
		success : function(data) {
			// alert(data);
			$("#dynamicContent").html(data);
			// alert(data);
...
function editCompanyClicked(id) {
	// $("#result").html("");
	var companyName = $('#companyName').val();
	var abbreviation = $('#bbreviation').val();
	...
	$.ajax({
		type : "GET",
		url : "company/goShowEditCompany?id="+id,
		cache : false,
		success : function(data) {
			$("#dynamicContent").html(data);
		}
...
function deleteModeCompanyClicked(attrId) {
	// alert(usedId);
	var NewDialog = $("<div id='MenuDialog' title='Company'>\<p>\<span class='ui-icon ui-icon-info' "
			+ "style='float: left; margin: 0 7px 20px 0;'> "
			+ "</span><b>Do you want to deactivate?</b></p>\</div>");
	NewDialog.dialog({
		resizable : false,
		...
		buttons : {
			"Yes" : {
				...
				click : function() {
					...
					$.ajax({
						type : "GET",
						url : "company/goDeleteCompany" + "?id=" + attrId,
						cache : false,
						success : function(data) {
							$("#showDynamicContent").html("");
							$("#dynamicContent").html(data);
...
function unDeleteModeCompanyClicked(attrId) {
	// alert(usedId);
	var NewDialog = $("<div id='MenuDialog' title='Company'>\<p>\<span class='ui-icon ui-icon-info' "
			+ "style='float: left; margin: 0 7px 20px 0;'> "
			+ "</span><b>Do you want to Activate?</b></p>\</div>");
		...
		buttons : {
			"Yes" : {
				...
				click : function() {
					...
					$.ajax({
						type : "GET",
						url : "company/goUnDeleteCompany" + "?id=" + attrId,
						cache : false,
						success : function(data) {
							$("#showDynamicContent").html("");
							$("#dynamicContent").html(data);
...
function userCompanyGroupClicked(userId) {
	$.ajax({
		type : "GET",
		url : "user/goShowUserCompanyGroupAssignment" + "?id=" + userId,
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
			$('#userCompanyGroupAssignmentLists').dataTable({
				"bJQueryUI" : true,
				"bPaginate" : false,
				"sScrollY" : "410px",
				"sScrollX" : "300px",
...
function assignSecGrp(formTypeId) {
	$.ajax({
		type : "GET",
		url : "forms/goShowSecGroupAssignment" + "?id=" + formTypeId,
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
			$('#secGrpAssignmentLists').dataTable({
				"bJQueryUI" : true,
				"bPaginate" : false,
				"sScrollY" : "410px",
				"sScrollX" : "300px",
...
function assignCompanyGrp(formTypeId) {
	$.ajax({
		type : "GET",
		url : "company/goShowCompanyGroupAssignment" + "?id=" + formTypeId,
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
			$('#companyGrpAssignmentLists').dataTable({
				"bJQueryUI" : true,
				"bPaginate" : false,
				"sScrollY" : "410px",
				"sScrollX" : "300px",
...
function deleteSecGrpForForm(formTypeId, secGroupId) {

	var NewDialog = $("<div id='MenuDialog' title='Form Security Group'>\<p>\<span class='ui-icon ui-icon-info' "
			+ "style='float: left; margin: 0 7px 20px 0;'> "
			+ "</span><b>Are you sure you want to delete it?</b></p>\</div>");
	NewDialog.dialog({
		resizable : false,
		...
		buttons : {
			"Yes" : {
				...
				click : function() {
					...
					$.ajax({
						type : "GET",
						url : "forms/deleteSecGroupFromForm" + "?secGrpId="
								+ secGroupId + "&formTypeId=" + formTypeId,
						cache : false,
						success : function(data) {
							$("#showDynamicContent").html("");
							$("#dynamicContent").html(data);
...
function deleteCompanyGrpForForm(formTypeId, companyGroupId) {

	var NewDialog = $("<div id='MenuDialog' title='Form Company Group'>\<p>\<span class='ui-icon ui-icon-info' "
			+ "style='float: left; margin: 0 7px 20px 0;'> "
			+ "</span><b>Are you sure you want to delete it?</b></p>\</div>");
	NewDialog.dialog({
		resizable : false,
		...
		buttons : {
			"Yes" : {
				...
				click : function() {
					...
					$.ajax({
						type : "GET",
						url : "company/deleteCompanyGroupFromForm" + "?compGrpId="
								+ companyGroupId + "&formTypeId=" + formTypeId,
						cache : false,
						success : function(data) {
							$("#showDynamicContent").html("");
							$("#dynamicContent").html(data);
...
function deleteCompanyForUser(userId, attrValueId) {

	var NewDialog = $("<div id='MenuDialog' title='Company Group'>\<p>\<span class='ui-icon ui-icon-info' "
			+ "style='float: left; margin: 0 7px 20px 0;'> "
			+ "</span><b>Are you sure you want to delete it?</b></p>\</div>");
	NewDialog.dialog({
		resizable : false,
		...
		buttons : {
			"Yes" : {
				...
				click : function() {
					...
					$.ajax({
						type : "GET",
						url : "user/deleteCompanyFromUser" + "?userId="
								+ userId + "&attrValueId=" + attrValueId,
						cache : false,
						success : function(data) {
							$("#showDynamicContent").html("");
							$("#dynamicContent").html(data);
...
function addCompanyForUserClicked(userId, attrValueId) {
	
	$.ajax({
		type : "GET",
		url : "user/addCompanyToUser" + "?userId=" + userId
...
function addSecGrpForFormClicked(formTypeId, secGroupId) {
	
	$.ajax({
		type : "GET",
		url : "forms/addSecGroupFromForm" + "?secGrpId=" + secGroupId
...
function addCompanyGrpForFormClicked(formTypeId, compGroupId) {
	
	$.ajax({
		type : "GET",
		url : "company/addCompanyGroupFromForm" + "?compGrpId=" + compGroupId
				+ "&formTypeId=" + formTypeId,
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
...
function deleteDraftForm(userFormId){
	var NewDialog = $("<div id='MenuDialog' title='Draft Form'>\<p>\<span class='ui-icon ui-icon-info' "
			+ "style='float: left; margin: 0 7px 20px 0;'> "
			+ "</span><b>Are you sure you want to delete it?</b></p>\</div>");
	NewDialog.dialog({
		resizable : false,
		...
		buttons : {
			"Yes" : {
				...
				click : function() {
					...
					$.ajax({
						type : "GET",
						url : "forms/deleteDraftForm" + "?userFormId=" + userFormId,
						cache : false,
						success : function(data) {
							//alert(data);
							refreshTray();
...
function formTitleCheck(){
	var title=$('#f_5_7').val();
	var title1=$('#f_3_2').val();
	var title2=$('#f_4_1').val();
	var surname=$('#f_3_9_15').val();
	var firstName=$('#f_3_9_16').val();
	var contact=$('#f_3_9_17').val();
	var employee=$('#f_3_9_18').val();
	var address=$('#f_3_9_19').val();
	var reportingPersonChecked=($("#f_3_8").attr("checked"))?"true":"false";
	var firstAidCheck=($("#f_3_13").attr("checked"))?"true":"false";
	var firstAidApplied=$('#f_3_14').val();
	var secGrp=$('#secGrp').val();
	var compGrp=$('#compGrp').val();
	var wf=$('#wrkFlw').val();
	//alert(title);
	patt = /^[a-zA-Z0-9_\s\[\]]*$/g;
	patt3 = /^[a-zA-Z0-9_\s\[\]]*$/g;
	patt4 = /^[a-zA-Z0-9_\s\[\]]*$/g;
	patt2 = /^[0-9_\s\[\]]*$/g;
	patt5 = /^[0-9_\s\[\]]*$/g;
	
	if(secGrp == "-1"){
		dialogTemplateLinks("Form Save", "Please select Security Group");
		return false;
	}
	
	if(wf == "-1"){
		dialogTemplateLinks("Form Save", "Please select Workflow");
		return false;
	}
	
	if(compGrp == "-1"){
		dialogTemplateLinks("Form Save", "Please select Company");
		return false;
	}
	
	if(!patt.test(title)==true){
		dialogTemplateLinks("Form Save", "No special characters allowed in Product Name");
		return false;
	}
	if(!patt3.test(title1)==true){
		dialogTemplateLinks("Form Save", "No special characters allowed in Type of Injury");
		return false;
	}
	if(!patt4.test(title2)==true){
		dialogTemplateLinks("Form Save", "No special characters are allowed in Project Title");
		return false;
	}
	
	if(reportingPersonChecked != "false"){
	
	if(contact == "" || firstName == "" || surname == "" || contact == "" || employee == "" || address == ""){
		dialogTemplateLinks("Form Save", "Reporting person fields are mandatory");
		return false;
		}
		
	if(!patt2.test(contact)==true){
			dialogTemplateLinks("Form Save", "Only Numbers allowed in Employee and Contact Number field");
			return false;
			}

	if( !patt5.test(employee)==true){
			dialogTemplateLinks("Form Save", "Only Numbers allowed in Employee and Contact Number field");
			return false;
			}
		
		}
		if(firstAidCheck != "false"){
		
			if(firstAidApplied == ""){
		dialogTemplateLinks("Form Save", "First Aid applied field is mandatory");
		return false;
		}
		}	
}

/*function formDataSubmit(frmData,secGrp,workFlow,submissionDate,companyGrp) {
	var body = $("html, body");
	if(formTitleCheck()==false){
		return false;
	}
	...
	if (submissionDate == "") {
		...
		var subDate = submissionDate.split("-");
		var targDate = new Date(subDate[2], subDate[1] - 1, subDate[0]);
		if (targDate <= now) {
	...
	$.ajax({
		type : "POST",
		url : "forms/create?secGrp="+secGrp+"&workFlow="+workFlow+"&submissionDate="+submissionDate +"&compGrp="+companyGrp,
		cache : false,
		data : frmData,
		success : function(data) {
			// $("#dynContent").html(data);
...
function formDataSave(frmData,secGrp,submissionDate,companyGrp) {
	...
	$.ajax({
		type : "POST",
		url : "forms/saveForDraft?secGrp="+secGrp+"&submissionDate="+submissionDate+"&compGrp="+companyGrp,
		cache : false,
		data : frmData,
		success : function(data) {
			// alert("inside");
...
function formDataSubmit(frmData,secGrp,workFlow,submissionDate,companyGrp,modelId) {
	var body = $("html, body");
	if(formTitleCheck()==false){
		return false;
	}
...
function formDataSave(frmData,secGrp,submissionDate,companyGrp,modelId) {
	...
	$.ajax({
		type : "POST",
		url : "forms/saveForDraft?secGrp="+secGrp+"&submissionDate="+submissionDate+"&compGrp="+companyGrp+"&wrkFlw="+modelId,
		cache : false,
		data : frmData,
		success : function(data) {
			// alert("inside");
...
function formDataUpdate(frmData,secGrp,submissionDate) {
	...
	$.ajax({
		type : "POST",
		url : "forms/saveForUpdate?secGrp="+secGrp+"&submissionDate="+submissionDate,
		cache : false,
		data : frmData,
		success : function(data) {
			eval(data);
...
function onPickFormClicked(path, formName, caseId, stepId,adminMeta) {
	$.ajax({
		type : "GET",
		url : "dash/pickForm?path=" + path + "&formName=" + formName
				+ "&caseId=" + caseId + "&stepId=" + stepId + "&adminMeta="+adminMeta,
		cache : false,
		success : function(data) {
...
function loadFormProperties(formName, path, caseId, stepList,adminMeta) {
	//alert(stepList);
	$.ajax({
		type : "GET",
		url : "dash/metaDataForForm" + "?path=" + path + "&formName="
				+ formName + "&caseId=" + caseId + "&stepList=" + stepList +"&adminMeta="+adminMeta,
		cache : false,
		success : function(data) {
			$("#dynContentMetadata").html(data);
			$("#dynamicContent").html(data);
...
/*function loadFormPropertiesAdmin(formName, path, caseId, stepList) {
	//alert(stepList);
	$.ajax({
		type : "GET",
		url : "adminTemplate/metaDataForForm" + "?path=" + path + "&formName="
...
function showFormBtnClicked(userFormId) {
	/*window.open('http://192.168.1.52/ajax.html','mypopup',
	  'status=1,width=500,height=500,scrollbars=1');*/
	window.open("forms/showStaticForm?userFormId=" + userFormId, "userform_"
			+ userFormId, "status=1,width=500,height=500,scrollbars=1");
	
	/*window.open("forms/showStaticJspForm?userFormId=" + userFormId, "userform_"
			+ userFormId, "height=600,width=1000,left=100,top=50,resizable=yes,location=no,scrollbars=yes,toolbar=yes,status=yes");*/
}

function formBtnClicked(userFormId,adminMeta) {
	$.ajax({
		type : "GET",
		url : "forms/showForm" + "?userFormId=" + userFormId +"&adminMeta="+adminMeta,
		cache : false,
		success : function(data) {
...
//changes done for forms document reference link addition

function searchBtnLinksFormClicked() {
...
function showFormsForModelMap() {
	//alert("comes in");
	$.ajax({
		type : "GET",
		url : "forms/goShowFormTypesForModel",
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
			$('#formModelLists').dataTable({
				"bJQueryUI" : true,
				"sPaginationType" : "full_numbers",
				"iDisplayLength" : 25,
				"sScrollY" : "390px",
...
function assignModelForForm(formTypeId) {
	$.ajax({
		type : "GET",
		url : "forms/goShowFrmModelAssignment" + "?id=" + formTypeId,
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
			$("#dynamicContent").html(data);
			$('#modelFormAssignmentLists').dataTable({
				"bJQueryUI" : true,
				"bPaginate" : false,
				"sScrollY" : "410px",
				"sScrollX" : "300px",
...
function deleteModelForForm(formTypeId, modelId) {

	var NewDialog = $("<div id='MenuDialog' title='Form WorkFlow Managment'>\<p>\<span class='ui-icon ui-icon-info' "
			+ "style='float: left; margin: 0 7px 20px 0;'> "
			+ "</span><b>Are you sure you want to delete it?</b></p>\</div>");
	NewDialog.dialog({
		resizable : false,
		...
		buttons : {
			"Yes" : {
				...
				click : function() {
					...
					$.ajax({
						type : "GET",
						url : "forms/deleteModelFromForm" + "?modelId="
								+ modelId + "&formTypeId=" + formTypeId,
						cache : false,
						success : function(data) {
							$("#showDynamicContent").html("");
							$("#dynamicContent").html(data);
...
function addModelForFormClicked(formTypeId, modelId) {
	
	$.ajax({
		type : "GET",
		url : "forms/addModelForForm" + "?modelId=" + modelId
				+ "&formTypeId=" + formTypeId,
		cache : false,
		success : function(data) {
			$("#showDynamicContent").html("");
