...
<div class="bg_title">
		...
		<form method="post" id="editCompanyFrm" name="editCompanyFrm">
		<input type="hidden" value="${companyId}" name="companyId" id="companyId">
 <table cellspacing="7">
            <tr>
              <td class="label">Company Name</td>
              <td class="star">*</td>
              <td><input id="companyName" name="companyName" type="text" value="${companyName }"  maxlength="44"  class="text" style="width: 196px;"/></td>
             ...
             <tr>
              ...
              <td class="star">*</td>
              <td><input id="abbreviation" name="abbreviation" type="text" value="${companyAbbr }"  maxlength="5"  class="text" style="width: 196px;"/></td>
            </tr>
            
            <tr>
              <td></td>
              <td></td>
              <td><input type="button" class="download" value="Save"  onclick="editCompany();"/>
