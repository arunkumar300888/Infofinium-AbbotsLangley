...
<form method="post" id="formDatas">
		...
		<p align="left">
				<b><font size="3" >Customer Appointment Request Form</font></b>
			</p> <br/>
			...
			<br/>
				<label class="FormFieldLabelRequired" for="f_5_5" title="Landline Number">Date:</label>
				<input class="text  datepicker" id="f_5_5" name="f_5_5" type="text"/>
				<br/>
				
				<label class="FormFieldLabelRequired" for="f_5_5" title="Landline Number">Time:</label>
				<input class="text  datepicker" id="f_5_5" name="f_5_5" type="text"/>
				<br/>
			
				<label class="FormFieldLabelRequired" for="f_9_3" title="Product Name">Which Country are you from?:</label>
				<select class="text" id="f_5_2">
				<option value="-1">Select</option>
				
				</select>
			<br/>
				<label class="FormFieldLabelRequired" for="f_5_6" title="Mobile Number">Location:</label>
				<input class="text" id="f_5_6" name="f_5_6" type="text"/>
			<br/>
				
			
				<label class="FormFieldLabelRequired" for="f_5_8" title="Address">Reason For Meeting:</label>				
				<textarea class="text" cols="50" id="f_5_8" name="f_5_8" rows="6"> </textarea>
			<br/>
			
			<label class="FormFieldLabelRequired" for="f_5_5" title="Landline Number">Event Date:</label>
				<input class="text  datepicker" id="f_5_5" name="f_5_5" type="text"/>
				<br/>
			...
			<label class="FormFieldLabelRequired" for="f_5_6" title="Mobile Number">Contact Telephone Number:</label>
				<input class="text" id="f_5_6" name="f_5_6" type="text"/>
			<br/>
			
			<label class="FormFieldLabelRequired" for="f_5_8" title="Address">Additional Information:</label>				
				<textarea class="text" cols="50" id="f_5_8" name="f_5_8" rows="6"> </textarea>
			<br/>
		</p>		
