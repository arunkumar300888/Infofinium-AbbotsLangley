...
<div style="width: 98%; margin: 0 auto;">
			<fieldset>
				...
				<form method="post" id="frmSearchLinks" style="padding: 5px">
					...
					<label>Document Type</label> <select name="documentTypeLinks" class="text"
					...
					<label>${attr4}</label> <select name="sitesLinks" id="sitesLinks" class="text"
						onkeypress="searchKeyPressLinks(event);">
						<option value="-1" selected="selected">--Select--</option>
					...
					<label>${attr3}</label> <select name="disciplineLinks" id="disciplineLinks"
					...
					<label>Unique Doc ID/Eb Number</label> <input type="text" name="ebNoLinks" id="ebNoLinks"
						...
						onClick="searchBtnLinksClicked();" /> <input type="reset"
...
<div class="float-left" style="width: 100%; margin-top: 10px;">
			...
			<div id="documentLinks" style="min-height: 600px;">
