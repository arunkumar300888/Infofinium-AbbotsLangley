...
<form method="post" id="formDatas">
	...
	<p align="center">
				<b><font size="3" >Standard Product Customer Order Form</font></b>
			</p>
			<p>
				<label class="FormFieldLabelRequired" for="f_17_1" title="Terms">Terms and Conditions:</label>
			...
			<p>
				<label class="FormFieldLabelRequired" for="f_17_3" title="Shipping Address">Shipping Address:</label>
				<input class="text" id="f_17_3" name="f_17_3" type="text" maxlength="10"/>
			</p>
			...
			<table class="display">
				...
				<p>
				<label class="FormFieldLabelRequired" for="f_17_3" title="Order Status">Order Status</label>
				<select class="text" id="f_13_5">
